...
export class GitHubService extends Context.Service<GitHubService, IGitHubService>()(
  "GitHubService",
  {
    make: E.gen(function* () {
  ...
  static readonly layer = Layer.effect(this, this.make).pipe(Layer.provide(Environment.layer));
}
